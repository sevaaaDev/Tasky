...
export function editTaskDOM(container,currentProject, projectIndex, taskIndex, realTaskIndex) {
  ...
  inputDate.value = lightFormat(container[projectIndex].task[realTaskIndex].dueDate, 'yyyy-MM-dd')
  title.remove()
  task.insertBefore(inputTitle, date)
  task.insertBefore(inputDate, date)
  date.remove()
  inputTitle.focus()
