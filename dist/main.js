...
function displayTaskToDOM(container, projectIndex) {
  ...
  for (let task of container[projectIndex].task) {
    ...
    dueDate.innerText = `Due ${(0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(task.dueDate), 'd MMM yyyy')}`
...
function displayFilteredTask(container, buttons, projectIndex) {
  (0,_displayReset__WEBPACK_IMPORTED_MODULE_0__.resetTaskDisplay)()
  let filtered = (0,_taskFilter__WEBPACK_IMPORTED_MODULE_2__.filter7days)(container) 
  if (projectIndex === "Today Tasks") {
    filtered = (0,_taskFilter__WEBPACK_IMPORTED_MODULE_2__.filterToday)(container)
  }
  const taskContainer = document.querySelector('.main--task-container')
...
/* harmony export */ });
/* harmony import */ var date_fns_lightFormat__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns/lightFormat */ "./node_modules/date-fns/esm/lightFormat/index.js");
...
function editTaskDOM(container, currentProject, projectIndex, taskIndex, projectID, taskID) {
  ...
  inputDate.value = (0,date_fns_lightFormat__WEBPACK_IMPORTED_MODULE_1__["default"])(container[projectIndex].task[taskIndex].dueDate, 'yyyy-MM-dd')
  title.remove()
...
function editTask(container, projectIndex, taskIndex, name, dueDate) {
...
/* harmony import */ var _taskFilter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./taskFilter.js */ "./src/taskFilter.js");
/* harmony import */ var _projectEditor_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./projectEditor.js */ "./src/projectEditor.js");
/* harmony import */ var _displayController_editProject_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./displayController/editProject.js */ "./src/displayController/editProject.js");
...
function formTask(e) {
  ...
  ;(0,_taskCreator_js__WEBPACK_IMPORTED_MODULE_0__.createTask)(container, currentProject, inputTitle.value, inputDate.value);
  localStorage.setItem('container',JSON.stringify(container))
...
function removeTheTask(e) {
  ...
  ;(0,_displayController_editTask_js__WEBPACK_IMPORTED_MODULE_5__.removeTaskDOM)(task.dataset.project, task.dataset.index)
  console.log(container)
}
...
function removeTheProject(e) {
  ...
  ;(0,_projectEditor_js__WEBPACK_IMPORTED_MODULE_8__.removeProject)(container, projectIndex)
  ;(0,_displayController_editProject_js__WEBPACK_IMPORTED_MODULE_9__.removeProjectDOM)(project.dataset.index)
  console.log((0,_taskCreator_js__WEBPACK_IMPORTED_MODULE_0__.getProjectIndex)(container, project.dataset.index))
